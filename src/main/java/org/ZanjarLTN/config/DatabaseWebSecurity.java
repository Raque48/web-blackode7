...
//Las vistas públicas no requieren autenticación
		.requestMatchers("/", "/signup", "login", "/search", "/index/view/**").permitAll()

		.requestMatchers("/sonidos/**").hasAnyAuthority("ADMINISTRADOR")
		.requestMatchers("/usuario/**").hasAnyAuthority("ADMINISTRADOR", "USER")
